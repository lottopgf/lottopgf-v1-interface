        ...
        <AlertDialog open={isConnectedToUnsupportedChain}>
            <AlertDialogContent>
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        Please connect to {defaultChain.name} to use this application. Note that
                        some wallets like Rainbow might not support custom chains. In that case
                        please use another wallet.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                    <AlertDialogCancel onClick={() => disconnect()}>Disconnect</AlertDialogCancel>
                    <AlertDialogAction onClick={() => switchChain({ chainId: defaultChain.id })}>
