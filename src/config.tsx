...
export const CONTRACT_ADDRESS: Address = '0xF7d114B2F637fE7Cf7aD659BbA43B1FE64D815eC'

// The address of the ETH adapter contract
export const LOOTERY_ETH_ADAPTER_ADDRESS: Address = '0xF9aC611be31983EB9030d2F201Af566b59d5BCE2'

// The URL of the GraphQL API to get ticket data
export const GRAPHQL_API = 'https://lootery-v1-indexer-base-prod.up.railway.app'
